...
const AllUsers = () => {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3">
          <button
            type="button"
            onClick={onClose}
            className="w-full sm:w-auto px-4 py-2 rounded cursor-pointer bg-gray-300 hover:bg-gray-400"
          >
            Cancel
          </button>
          <button
            type="submit"
            className="w-full sm:w-auto px-4 py-2 rounded cursor-pointer bg-primary text-white hover:bg-primary/80"
          >
            Save
          </button>
        </div>
  ...
  return (
    <div className="px-3 py-4 sm:px-6 min-h-screen">
      {/* Toolbar Section */}
      ...
      <AnimatePresence>
        {showAddModal && (
          ...
          >
            <motion.div
              className="bg-white rounded-2xl p-4 sm:p-6 w-[95%] max-w-md shadow-2xl relative"
      ...
      <AnimatePresence>
        {selectedUser && isEdit && (
          ...
          >
            <motion.div
              className="bg-white p-4 sm:p-6 rounded-2xl w-[95%] max-w-md shadow-2xl relative"
              initial={{ y: -50, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
              exit={{ y: -50, opacity: 0 }}
            >
