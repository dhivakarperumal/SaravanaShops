...
const Invoice = () => {
  ...
  // ── Body scroll lock when filter drawer open ───────────────────────────────
  useEffect(() => {
  ...
  const openEditModal = (inv) => {
    setInvoiceData({
      ...
      billPdfBase64:    inv.billPdfBase64,
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {displayed.map((item, idx) => (
                    <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-5 py-3.5 text-gray-500">{item.invoiceDate}</td>
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-0.5">{item.invoiceDate}</p>
                    </div>
