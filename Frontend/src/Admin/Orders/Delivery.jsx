    ...
    const html = `<div style="font-family:Arial,sans-serif;color:#333;padding:30px;">
      ...
      <div style="display:flex;justify-content:space-between;margin-top:20px;flex-wrap:wrap;">
        <div style="width:48%;min-width:240px;font-size:16px;">
          <h3 style="font-size:20px;margin-bottom:10px;">To: Customer Details</h3>
        ...
        <div style="width:48%;min-width:240px;font-size:16px;">
          <h3 style="font-size:20px;margin-bottom:10px;">From: Order Details</h3>
      ...
      <div style="text-align:center;margin-top:40px;font-size:13px;color:#666;border-top:1px solid #ccc;padding-top:10px;">
        Thank you for shopping with <strong>Sri Saravana Shoppings</strong>!
      </div>
    </div>`;
                ...
                {currentOrders.length === 0 ? (
                  <tr><td colSpan={9} className="py-16 text-center text-gray-400">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-sm">No delivered orders found</span>
                    </div>
                  </td></tr>
                  ...
                  <tr key={order.docId} className="hover:bg-gray-50/70 transition">
                    ...
                    <td className="px-4 py-3 text-center">
                      <span className="bg-emerald-100 text-emerald-700 border border-emerald-300 text-xs px-3 py-1 rounded-full font-medium">
                        Delivered
                      </span>
                    </td>
                    <td className="px-4 py-3 text-center">
          ...
          {currentOrders.length === 0 ? (
            ...
            <div key={order.docId} className="bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md transition-shadow p-4 flex flex-col gap-3">
              ...
              <div className="grid grid-cols-2 gap-1 text-xs text-gray-500">
                ...
                {order.docketNumber && (<><span>LR No</span><span className="text-right text-gray-700 truncate">{order.docketNumber}</span></>)}
              </div>
